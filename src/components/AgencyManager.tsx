                                ...
                                <div className="flex gap-1">
                                  <button
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      e.preventDefault();
                                      console.log('[AgencyManager] Edit CLIENT clicked:', client.name, client.id);
                                      startEditClient(client);
                                    }}
                                    className="text-gray-500 hover:text-brand-cyan hover:bg-brand-cyan/20 p-2 rounded cursor-pointer transition-all relative z-50"
                                    title="Edit Client"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="text-gray-500 hover:text-red-400 hover:bg-red-400/20 p-2 rounded cursor-pointer transition-all relative z-50"
                                    title="Delete Client"
                                  >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  {isSelected && (
                                    <button
                                      ...
                                      className="text-gray-500 hover:text-white hover:bg-white/20 p-2 rounded cursor-pointer transition-all relative z-50 ml-2"
                                      title="Close"
                                    >
                                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                                          ...
                                          <div className="flex items-center justify-between">
                                            ...
                                            {isSelected && (
                                              <div className="flex gap-1">
                                                <button
                                                  type="button"
                                                  onClick={(e) => { e.stopPropagation(); e.preventDefault(); startEditLocation(loc); }}
                                                  className="text-gray-500 hover:text-brand-cyan hover:bg-brand-cyan/20 p-2 rounded cursor-pointer transition-all relative z-50"
                                                  title="Edit Location"
                                                >
                                                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <button
                                                  type="button"
                                                  onClick={(e) => { e.stopPropagation(); e.preventDefault(); deleteLocation(loc.id); }}
                                                  className="text-gray-500 hover:text-red-400 hover:bg-red-400/20 p-2 rounded cursor-pointer transition-all relative z-50"
                                                ...
                                                <>
                                                  <button
                                                    ...
                                                    onClick={(e) => {
                                                      e.stopPropagation();
                                                      e.preventDefault();
                                                      console.log('[AgencyManager] Edit website clicked:', web.name, web.id);
                                                      startEditWebsite(web);
                                                    }}
                                                    className="text-gray-500 hover:text-brand-cyan hover:bg-brand-cyan/20 p-2 rounded cursor-pointer transition-all relative z-50"
                                                    title="Edit Website"
                                                  >
                                                  ...
                                                  <button
                                                    type="button"
                                                    onClick={(e) => { e.stopPropagation(); e.preventDefault(); deleteWebsite(web.id); }}
                                                    className="text-gray-500 hover:text-red-400 hover:bg-red-400/20 p-2 rounded cursor-pointer transition-all relative z-50"
