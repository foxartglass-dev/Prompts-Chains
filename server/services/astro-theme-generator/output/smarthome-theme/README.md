# @styleset/smarthome-glass-theme
...
```bash
npm install @styleset/smarthome-glass-theme
```
...
```js
// tailwind.config.mjs
import themePreset from '@styleset/smarthome-glass-theme/tailwind-preset';

export default {
  presets: [themePreset],
  content: [
    './src/**/*.{astro,html,js,jsx,md,mdx,ts,tsx,vue}',
    './node_modules/@styleset/smarthome-glass-theme/src/components/**/*.astro',
  ],
};
```
...
```astro
---
import Card from '@styleset/smarthome-glass-theme/components/Card.astro';
import Button from '@styleset/smarthome-glass-theme/components/Button.astro';
import Input from '@styleset/smarthome-glass-theme/components/Input.astro';
---
